...
public class Kuis_Ipa_Kelas6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_ipa_kelas6);

        getSupportActionBar().setTitle("SOAL IPA - 6");
        ...
        proses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (value_no1.isChecked() && value_no2.isChecked() && value_no3.isChecked() && value_no4.isChecked() && value_no5.isChecked())
                {
                    ...
                    Intent i = new Intent(Kuis_Ipa_Kelas6.this, Kuis_Ipa_Kelas6_Hasil.class);
