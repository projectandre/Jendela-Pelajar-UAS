...
public class Kuis_Ipa_Kelas5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_ipa_kelas5);

        getSupportActionBar().setTitle("SOAL IPA - 5");
        ...
        proses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (value_no1.isChecked() && value_no2.isChecked() && value_no3.isChecked() && value_no4.isChecked() && value_no5.isChecked())
                {
                    ...
                    if (value_no1.getText().toString().toLowerCase().equals("nonmagnetik")) {
                        nilai = nilai + 10;
                    }
                    if (value_no2.getText().toString().toLowerCase().equals("benda menjadi licin")) {
                        nilai = nilai + 10;
                    }
                    if (value_no3.getText().toString().toLowerCase().equals("dipanaskan")) {
                        nilai = nilai + 10;
                    }
                    if (value_no4.getText().toString().toLowerCase().equals("dorongan")) {
                        nilai = nilai + 10;
                    }
                    if (value_no5.getText().toString().toLowerCase().equals("mengubah bentuk benda")) {
                        nilai = nilai + 10;
                    }
                    if (value_no6.getText().toString().toLowerCase().equals("gunting dan tang")) {
                        nilai = nilai + 10;
                    }
                    if (value_no7.getText().toString().toLowerCase().equals("memindahkan pohon ke dalam truk dengan menggunakan papan.")) {
                        nilai = nilai + 10;
                    }
                    if (value_no8.getText().toString().toLowerCase().equals("tetap")) {
                        nilai = nilai + 10;
                    }
                    if (value_no9.getText().toString().toLowerCase().equals("sepeda dan mobil")) {
                        nilai = nilai + 10;
                    }
                    if (value_no10.getText().toString().toLowerCase().equals("merambat berbalik")) {
                        nilai = nilai + 10;
                    }

                    Intent i = new Intent(Kuis_Ipa_Kelas5.this, Kuis_Ipa_Kelas5_Hasil.class);
