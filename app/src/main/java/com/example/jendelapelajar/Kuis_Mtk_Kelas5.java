...
public class Kuis_Mtk_Kelas5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_mtk_kelas5);

        getSupportActionBar().setTitle("SOAL MTK - 5");
        ...
        proses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (value_no1.isChecked() && value_no2.isChecked() && value_no3.isChecked() && value_no4.isChecked() && value_no5.isChecked())
                {
                    ...
                    if (value_no1.getText().toString().toLowerCase().equals("lancip")) {
                        nilai = nilai + 10;
                    }
                    if (value_no2.getText().toString().toLowerCase().equals("7.200 detik")) {
                        nilai = nilai + 10;
                    }
                    if (value_no3.getText().toString().toLowerCase().equals("99")) {
                        nilai = nilai + 10;
                    }
                    if (value_no4.getText().toString().toLowerCase().equals("2.000 m")) {
                        nilai = nilai + 10;
                    }
                    if (value_no5.getText().toString().toLowerCase().equals("410 m")) {
                        nilai = nilai + 10;
                    }
                    if (value_no6.getText().toString().toLowerCase().equals("33 m")) {
                        nilai = nilai + 10;
                    }
                    if (value_no7.getText().toString().toLowerCase().equals("300 dm")) {
                        nilai = nilai + 10;
                    }
                    if (value_no8.getText().toString().toLowerCase().equals("750 m")) {
                        nilai = nilai + 10;
                    }
                    if (value_no9.getText().toString().toLowerCase().equals("3.000 kg")) {
                        nilai = nilai + 10;
                    }
                    if (value_no10.getText().toString().toLowerCase().equals("105 kg")) {
                        nilai = nilai + 10;
                    }

                    Intent i = new Intent(Kuis_Mtk_Kelas5.this, Kuis_Mtk_Kelas5_Hasil.class);
