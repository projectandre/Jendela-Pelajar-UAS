...
public class Kuis_Ips_Kelas4_Hasil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_ips_kelas4_hasil);
        ...
        btn_materi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Kuis_Ips_Kelas4_Hasil.this, MateriIPS.class);
                finish();
                startActivity(i);
        ...
        cobalagi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Kuis_Ips_Kelas4_Hasil.this, Kuis_Ips_Kelas4.class);
                finish();
                startActivity(i);
