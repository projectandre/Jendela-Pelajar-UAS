...
public class Kuis_Mtk_Kelas4_Hasil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_mtk_kelas4_hasil);
        ...
        btn_materi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Kuis_Mtk_Kelas4_Hasil.this, MateriMTK.class);
                finish();
                startActivity(i);
        ...
        cobalagi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Kuis_Mtk_Kelas4_Hasil.this, Kuis_Mtk_Kelas4.class);
                finish();
                startActivity(i);
