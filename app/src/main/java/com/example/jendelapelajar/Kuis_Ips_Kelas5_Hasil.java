...
public class Kuis_Ips_Kelas5_Hasil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_ips_kelas5_hasil);
        ...
        btn_materi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Kuis_Ips_Kelas5_Hasil.this, MateriIPS.class);
                finish();
                startActivity(i);
        ...
        cobalagi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Kuis_Ips_Kelas5_Hasil.this, Kuis_Ips_Kelas5.class);
                finish();
                startActivity(i);
