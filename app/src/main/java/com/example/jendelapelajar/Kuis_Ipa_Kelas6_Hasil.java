...
public class Kuis_Ipa_Kelas6_Hasil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_ipa_kelas6_hasil);
        ...
        btn_materi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Kuis_Ipa_Kelas6_Hasil.this, MateriIPA.class);
                finish();
                startActivity(i);
        ...
        cobalagi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Kuis_Ipa_Kelas6_Hasil.this, Kuis_Ipa_Kelas6.class);
                finish();
                startActivity(i);
