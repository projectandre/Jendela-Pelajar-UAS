...
public class Kuis_Ipa_Kelas4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_ipa_kelas4);

        getSupportActionBar().setTitle("SOAL IPA - 4");
        ...
        proses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (value_no1.isChecked() && value_no2.isChecked() && value_no3.isChecked() && value_no4.isChecked() && value_no5.isChecked())
                {
                    ...
                    if (value_no1.getText().toString().toLowerCase().equals("kecoa")) {
                        nilai = nilai + 10;
                    }
                    if (value_no2.getText().toString().toLowerCase().equals("kulit")) {
                        nilai = nilai + 10;
                    }
                    if (value_no3.getText().toString().toLowerCase().equals("kupu-kupu")) {
                        nilai = nilai + 10;
                    }
                    if (value_no4.getText().toString().toLowerCase().equals("mengenal keadaan luar tubuh")) {
                        nilai = nilai + 10;
                    }
                    if (value_no5.getText().toString().toLowerCase().equals("bau")) {
                        nilai = nilai + 10;
                    }
                    if (value_no6.getText().toString().toLowerCase().equals("nyamuk")) {
                        nilai = nilai + 10;
                    }
                    if (value_no7.getText().toString().toLowerCase().equals("daur hidup")) {
                        nilai = nilai + 10;
                    }
                    if (value_no8.getText().toString().toLowerCase().equals("ulat")) {
                        nilai = nilai + 10;
                    }
                    if (value_no9.getText().toString().toLowerCase().equals("kelinci")) {
                        nilai = nilai + 10;
                    }
                    if (value_no10.getText().toString().toLowerCase().equals("rangkaian tulang")) {
                        nilai = nilai + 10;
                    }

                    Intent i = new Intent(Kuis_Ipa_Kelas4.this, Kuis_Ipa_Kelas4_Hasil.class);
