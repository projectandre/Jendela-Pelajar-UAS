...
public class Kuis_Pkn_Kelas6_Hasil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_pkn_kelas6_hasil);
        ...
        btn_materi.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Kuis_Pkn_Kelas6_Hasil.this, MateriPKN.class);
                finish();
                startActivity(i);
        ...
        cobalagi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(Kuis_Pkn_Kelas6_Hasil.this, Kuis_Pkn_Kelas6.class);
                finish();
                startActivity(i);
