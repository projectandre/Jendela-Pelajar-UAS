...
public class Kuis_Ips_Kelas4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuis_ips_kelas4);

        getSupportActionBar().setTitle("SOAL IPS - 4");
        ...
        proses.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (value_no1.isChecked() && value_no2.isChecked() && value_no3.isChecked() && value_no4.isChecked() && value_no5.isChecked())
                {
                    ...
                    Intent i = new Intent(Kuis_Ips_Kelas4.this, Kuis_Ips_Kelas4_Hasil.class);
